            ...
            try:
                ...
                if response.candidates and response.candidates[0].content.parts:
                     ...
                     if block_reason:
                          ...
                          # Log the response structure if it's unexpected and empty
                          # print("Unexpected empty response structure:", response)

            except Exception as text_extract_error:
                 st.error(f"Error extracting text from response: {text_extract_error}")
                 st.write("Raw Response:", response) # Keep logging raw response for debugging
